...
KEYWORDS = [
    # AI видео — русские
    "ai видео", "нейросеть видео", "видео ai", "видео нейросеть",
    "сделать видео", "создать видео", "заказать видео", "видео генератор",
    "ai генератор", "видео из текста", "текст в видео", "видео из фото",
    "генерация видео", "нейросеть клип", "ai клип", "видео промпт",
    "промпт видео", "нейросеть анимация", "ai анимация", "видео нейро",
    "нейро видео", "ai ролик", "ролик нейросеть", "ai короткометражка",
    "видео из картинки", "картинка в видео", "фото в видео", "ai мультфильм",
    "нейросеть мультфильм", "ai кино", "нейросеть кино", "ai реклама",
    "реклама нейросеть", "ai рилс", "нейросеть рилс", "ai тикток",
    "нейросеть тикток", "ai ютуб", "нейросеть ютуб", "ai инстаграм",
    "нейросеть инстаграм", "ai сторис", "нейросеть сторис",

    # Сервисы AI видео
    "sora", "runway", "kling", "seedance", "pika", "luma",
    "stable video", "gen2", "gen3", "runway ml", "pika labs",
    "luma dream machine", "kling ai", "haiper", "moonvalley",
    "invideo ai", "synthesia", "heygen", "d-id", "did ai",
    "descript", "opus clip", "munch ai", "vidyo ai",
    "fliki", "pictory", "steve ai", "deepbrain", "hour one",
    "colossyan", "elai io", "rephrase ai", "tavus",

    # Цены и доступность
    "дешевое видео", "бюджетное видео", "видео цена", "видео стоимость",
    "бесплатное ai видео", "ai видео бесплатно", "дешевый ai",
    "недорогой ai", "бюджетный ai", "ai дешево", "ai бесплатно",
    "видео дешево", "видео недорого", "видео бесплатно",
    "сколько стоит ai", "цена нейросети", "стоимость нейросети",
    "ai подписка", "нейросеть подписка", "ai тариф",

    # Новички и обучение
    "новичок ai", "учусь ai", "начинаю ai", "ai обучение",
    "что такое ai", "ai для начинающих", "изучить ai", "ai курс",
    "нейросети новичок", "нейросети обучение", "учусь нейросетям",
    "начинаю нейросети", "нейросети курс", "ai школа",
    "нейросети школа", "ai урок", "нейросети урок",
    "ai туториал", "нейросети туториал", "ai гайд", "нейросети гайд",
    "ai для чайников", "нейросети для чайников", "первый ai",
    "первая нейросеть", "попробовать ai", "попробовать нейросеть",
    "хочу изучить ai", "хочу изучить нейросети",
    "как пользоваться ai", "как пользоваться нейросетью",
    "не понимаю ai", "не разбираюсь ai", "помогите ai",
    "помогите нейросеть", "объясните ai", "объясните нейросеть",

    # Сообщество и клуб
    "ai сообщество", "ai клуб", "ai группа", "ai чат",
    "нейросети сообщество", "ai комьюнити", "ai единомышленники",
    "нейросети клуб", "нейросети группа", "нейросети чат",
    "ai тусовка", "ai команда", "ai друзья", "ai коллеги",
    "ai форум", "нейросети форум", "ai discord", "ai telegram",
    "ai чат русский", "русское ai", "ai по русски",
    "нейросети по русски", "русские нейросети", "ai русский",
    "ищу ai друзей", "ai единомышленник", "ai партнер",
    "нейросети партнер", "ai коллаборация", "ai нетворкинг",

    # Помощь с AI
    "помощь ai", "помогите нейросеть", "ai не работает",
    "нейросеть не работает", "проблема ai", "проблема нейросеть",
    "ai вопрос", "нейросеть вопрос", "ai совет", "нейросеть совет",
    "ai рекомендация", "нейросеть рекомендация", "ai поддержка",
    "нейросеть поддержка", "ai эксперт", "нейросеть эксперт",
    "ai консультация", "нейросеть консультация",
    "посоветуйте ai", "посоветуйте нейросеть",
    "какой ai лучше", "какая нейросеть лучше",
    "ai сравнение", "нейросети сравнение", "топ ai",
    "топ нейросети", "лучший ai", "лучшая нейросеть",

    # Контент и творчество
    "ai контент", "нейросеть контент", "ai креатив",
    "нейросеть креатив", "ai творчество", "нейросеть творчество",
    "ai искусство", "нейросеть искусство", "ai арт", "нейросеть арт",
    "ai музыка", "нейросеть музыка", "ai текст", "нейросеть текст",
    "ai картинка", "нейросеть картинка", "ai фото", "нейросеть фото",
    "ai логотип", "нейросеть логотип", "ai дизайн", "нейросеть дизайн",
    "ai маркетинг", "нейросеть маркетинг", "ai продвижение",
    "нейросеть продвижение", "ai блог", "нейросеть блог",
    "ai пост", "нейросеть пост", "ai копирайтинг",
    "нейросеть копирайтинг", "ai смм", "нейросеть смм",

    # Бизнес и работа
    "ai бизнес", "нейросеть бизнес", "ai работа", "нейросеть работа",
    "ai автоматизация", "нейросеть автоматизация", "ai инструмент",
    "нейросеть инструмент", "ai продуктивность", "нейросеть продуктивность",
    "ai стартап", "нейросеть стартап", "ai проект", "нейросеть проект",
    "ai фриланс", "нейросеть фриланс", "ai заработок",
    "нейросеть заработок", "ai монетизация", "нейросеть монетизация",
    "зарабатываю ai", "зарабатываю нейросеть", "деньги ai",
    "деньги нейросеть", "доход ai", "доход нейросеть",

    # Популярные AI инструменты
    "chatgpt", "midjourney", "stable diffusion", "dall-e",
    "claude ai", "gemini ai", "grok ai", "mistral ai",
    "llama ai", "copilot ai", "perplexity ai", "notion ai",
    "jasper ai", "writesonic", "copy ai", "canva ai",
    "adobe firefly", "leonardo ai", "ideogram", "flux ai",

    # Английские — видео
    "ai video", "video ai", "neural video", "video generator",
    "make video ai", "create video ai", "cheap ai video",
    "ai video free", "ai video online", "ai video tool",
    "video from text", "text to video", "image to video",
    "ai animation", "neural animation", "ai film", "ai movie",
    "ai commercial", "ai ad video", "ai reel", "ai short",
    "ai youtube", "ai tiktok", "ai instagram", "ai content",
    "video creation ai", "ai video maker", "ai video editor",
    "best ai video", "top ai video", "ai video 2024", "ai video 2025",

    # Английские — обучение и сообщество
    "ai beginner", "learn ai", "ai course", "ai tutorial",
    "ai community", "ai club", "ai group", "ai discord",
    "ai forum", "ai network", "ai friends", "ai partner",
    "ai help", "ai support", "ai question", "ai advice",
    "how to use ai", "ai for beginners", "start with ai",
    "ai newbie", "new to ai", "ai learning", "ai education",

    # Английские — инструменты
    "sora ai", "runway ai", "kling video", "pika video",
    "luma ai", "seedance ai", "stable video diffusion",
    "ai tools", "best ai tools", "ai software", "ai app",
    "free ai", "cheap ai", "affordable ai", "ai subscription",
    "ai generator", "ai creator", "ai assistant",

    # Трендовые темы
    "нейросеть 2024", "нейросеть 2025", "ai 2024", "ai 2025",
    "тренды ai", "будущее ai", "ai революция", "ai технологии",
    "искусственный интеллект", "ии", "ии видео", "ии нейросеть",
    "генеративный ai", "генеративный ии", "llm", "gpt",
    "нейронная сеть", "машинное обучение", "deep learning",
    "нейросеть бесплатно", "нейросеть онлайн", "ai онлайн",

    # Вопросы и проблемы
    "где ai", "где нейросеть", "как ai", "как нейросеть",
    "зачем ai", "зачем нейросеть", "когда ai", "когда нейросеть",
    "ai или нейросеть", "ai vs нейросеть", "выбрать ai",
    "выбрать нейросеть", "стоит ли ai", "стоит ли нейросеть",
    "ai работает", "нейросеть работает", "попробовал ai",
    "попробовала ai", "использую ai", "использую нейросеть",
    "ai меняет", "нейросеть меняет", "ai помогает",
    "нейросеть помогает", "ai заменит", "нейросеть заменит",
]
...
class HealthHandler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        # OAuth callback — получаем code и меняем на токен
        if parsed.path == "/" and "code" in params:
            code = params["code"][0]
            try:
                r = requests.post(
                    "https://graph.threads.net/oauth/access_token",
                    data={
                        "client_id": "1735886881179416",
                        "client_secret": THREADS_APP_SECRET,
                        "grant_type": "authorization_code",
                        "redirect_uri": f"https://threads-autopost-7eto.onrender.com",
                        "code": code
                    }
                )
                data = r.json()
                ...
                msg = f"✅ Новый токен получен!\n\nТокен: {token}\nUser ID: {user_id}\n\nОбновите THREADS_ACCESS_TOKEN на Render!"
                if bot_app and ADMIN_CHAT_ID:
                    ...
                    asyncio.run_coroutine_threadsafe(
                        bot_app.bot.send_message(chat_id=ADMIN_CHAT_ID, text=msg),
                        loop
                    )
                self.send_response(200)
                self.end_headers()
                self.wfile.write(f"Token received! Check Telegram. Token: {token}".encode())
...
def search_threads_posts(keyword: str) -> list:
    try:
        ...
        data = r.json()
        if "error" in data:
            log.error(f"Search API error: {data['error']}")
            return []
...
def hunter_job():
    ...
    log.info(f"🔍 Hunter запущен, ищу по {len(KEYWORDS)} ключевым словам...")

    for keyword in KEYWORDS:
        total_searched += 1
        log.info(f"🔎 Ищу: '{keyword}' ({total_searched}/{len(KEYWORDS)})")
        ...
        for post in posts:
            ...
            try:
                ...
                if success:
                    ...
                    # Не останавливаемся — продолжаем искать дальше!
            except Exception as e:
    ...
    log.info(f"🔍 Hunter завершил поиск: проверено {total_searched} слов, ответил на {found_count} постов")
    
    if found_count == 0:
        log.info("🔍 Hunter: клиентов не найдено в этом проходе — жду следующего запуска")
    else:
        notify_admin(f"📊 *Итог поиска*\n\nОтветил на {found_count} постов\nПроверено ключевых слов: {total_searched}")

def run_hunter_scheduler():
    """Непрерывный поиск — закончил проход, сразу начинает следующий"""
    while True:
        hunter = load_hunter_settings()
        if not hunter.get("active"):
            time.sleep(10)
        ...
        hunter_job()
        # Минимальная пауза 5 сек чтобы не перегружать API
        time.sleep(5)
